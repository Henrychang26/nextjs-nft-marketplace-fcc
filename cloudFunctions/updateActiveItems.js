...
Moralis.Cloud.afterSave("ItemListed", async (request) => {
    //Every event get triggered twice, once on unconfirmed and again on confirmed
...
Moralis.Cloud.afterSave("ItemCanceled", async (request) => {
    ...
    if (confirmed) {
        ...
        query.equalTo("marketplaceAddress", request.object.get("address")) //check original contract for what is needed below
        query.equalTo("nftAddress", request.object.get("nftAddress"))
        query.equalTo("tokenId", request.object.get("tokenId"))
        ...
        if (canceledItem) {
            logger.info(
                await canceledItem.destroy()`Deleting ${request.object.get(
                    "tokenId"
